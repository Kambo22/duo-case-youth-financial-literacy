...
class Quiz1 : AppCompatActivity() {
    ...
    private fun handleAnswerSelection(isCorrect: Boolean) {
        ...
        if (isCorrect) {
            questionView.setBackgroundResource(R.drawable.questionright) // Correct answer background for question view
        } else {
            questionView.setBackgroundResource(R.drawable.questionwrong) // Wrong answer background for question view
        }
